                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="md:px-4 py-3">{{ Carbon\Carbon::parse($owner->created_at)->diffForHumans() }}</td>
                              <td class="md:px-4 py-3">
                                <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id ])}}'" class="text-white bg-green-400 border-0 py-2 px-4 focus:outline-none hover:bg-green-600 rounded ">編集</button>
                              </td>
